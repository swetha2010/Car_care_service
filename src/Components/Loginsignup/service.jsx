    ...
    return (
        <div className="app">
            ...
            <div className="services">
                <div className="box">
                    <img src={Disc_turning} alt="Disc Turning" />
                    <h3>Disc Turning</h3>
                </div>
                <div className="box">
                ...
                <div className="box">
                    <img src={AC_service_Repair} alt="AC Service & Repair" />
                    <h3>AC Service & Repair</h3>
                </div>
                <div className="box">
                    <img src={Car_spa_Cleaning} alt="Car Spa & Cleaning" />
                    <h3>Car Spa & Cleaning</h3>
                </div>
                <div className="box">
                    <img src={Tyres_Wheel_Care} alt="Tyres & Wheel Care" />
